...
const Stepper_upload = () => {
    ...
    const dataForStudent = (exam: Exam, student: Student) => {
        setExam(exam)
        setStudent(student)
    }
    ...
    const steps = [
        ...
        },
        {
            ...
            component: IsStudentTest ? <CheckStudentExams selectedImage={selectedImage} setDataForStudent={dataForStudent} />//SetDataForStudent={dataForStudent} />
